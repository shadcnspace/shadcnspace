  ...
  return (
    <BlockProvider key={block.name} name={block.name}>
      <div className="w-full mx-auto py-8">
        ...
        <Tabs defaultValue="preview" className="mt-6 gap-0 border border-border rounded-lg flex flex-col">
          <div className="flex flex-col flex-wrap md:items-end gap-2 justify-between p-3 border-b border-border">
