...
import { NavItem } from "@/components/shadcn-space/blocks/topbar-02/types";
              ...
              <li key={item.label}>
                <NavigationMenuLink
                  render={
                    <a
                      href={item.href}
                      className="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm hover:bg-accent hover:text-foreground"
                    >
                      <ItemIcon size={16} />
